                                            ...
                                            <tr class="table-product-receive">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="error-message-table-product">
                                                        <?php echo isset($errors["products[$key][code]"]) ? $errors["products[$key][code]"] : ''; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    ...
                                                    <input type="hidden" name="products[<?php echo $key; ?>][unit]"
                                                        value="<?php echo htmlspecialchars($unitValue); ?>" readonly>
                                                    <span class="error-message-table-product">
                                                        <?php echo isset($errors["products[$key][unit]"]) ? $errors["products[$key][unit]"] : ''; ?>
                                                    </span>
                                                </td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr class="table-product-receive">
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="products[0][code]" value="" readonly>
                                            </td>
                                            <td>
                                                <span class="display-product-unit">...</span>
                                                <input type="hidden" name="products[0][unit]" value="" readonly>
                                            </td>
...
<script>
    ...
    function updateProductCode(selectElement) {
        ...
        if (codeDisplay) codeDisplay.textContent = productCode;
    }
    ...
    function updateUnit(selectElement) {
        ...
        if (unitDisplay) unitDisplay.textContent = unitValue;
    }
